...
public final class BoxTrotConfig {
	@ConfigEntry(id = "doesBarrelFoolEndermen", translation = "config." + BoxTrot.MOD_ID + ".does_barrel_fool_endermen")
	public static boolean doesBarrelFoolEndermen = true;
	@ConfigEntry(id = "doesBarrelHideParticles", translation = "config." + BoxTrot.MOD_ID + ".does_barrel_hide_particles")
	public static boolean doesBarrelHideParticles = true;
	@ConfigEntry(id = "doesBarrelFoolMobs", translation = "config." + BoxTrot.MOD_ID + ".does_barrel_fool_mobs")
	public static boolean doesBarrelFoolMobs = true;
	@ConfigEntry(id = "doesBarrelFoolAttackers", translation = "config." + BoxTrot.MOD_ID + ".does_barrel_fool_attackers")
	public static boolean doesBarrelFoolAttackers = false;
	@ConfigEntry(id = "canOpenPlayerBarrels", translation = "config." + BoxTrot.MOD_ID + ".can_open_player_barrels")
	public static boolean canOpenPlayerBarrels = true;
	@ConfigEntry(id = "barrelRotates", translation = "config." + BoxTrot.MOD_ID + ".barrel_rotates")
